...
[specified in OpenAPI format](src/api_server/swagger/firecracker.yaml). You can view it via the [Swagger Editor](https://editor.swagger.io/?url=https://raw.githubusercontent.com/firecracker-microvm/firecracker/main/src/api_server/swagger/firecracker.yaml). Read more
